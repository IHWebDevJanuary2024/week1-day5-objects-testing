...
console.log(schoolSystem.schools[1].classRooms);
// Where is the first classroom?
console.log(schoolSystem.schools[1].classRooms[0]);
// We have teacher and students
console.log(schoolSystem.schools[1].classRooms[0].students);
const targetClass = schoolSystem.schools[1].classRooms[0].students
const newStudent = {firstName: 'Lucile', lastName: 'Lozano', age: null }
targetClass.push(newStudent)
console.log(targetClass)

// This is working but it's not so readable:
// schoolSystem.schools[1].classRooms[0].students.push({firstName: 'Lucile', lastName: 'Lozano', age: null })
